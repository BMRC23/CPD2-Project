...
<form action="editProfile" method="post" enctype="multipart/form-data">
    ...
    <ul id="uploadedFiles">
        ...
        <li>
            ...
            <button type="button" onclick="deleteFile('<%= file.getId() %>')">Delete</button>
        </li>
        <% } %>
        <% } else { %>
            ...
            if (confirmDelete) {
                ...
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        var fileElement = document.querySelector('li a[href="downloadFile?fileId=' + fileId + '"]').parentElement;
